...
@testset "Debye_Ashbaught_Hatch Potential" begin
    ...
    Model = SimulationParameters( FixedBondParameters(r), RandBondAngle(), RandTorsion(), Debye_Ashbaugh_Hatch(deepcopy(Sequence), OneToSigma, OneToLambda, ϵ_ah_l, rc_ah, OneToCharge, rc_deb, cs_deb, rel_T))
